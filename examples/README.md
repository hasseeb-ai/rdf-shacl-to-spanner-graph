...
| Domain / Schema | Ontology File | SHACL Shapes | Description |
| :--- | :--- | :--- | :--- |
| **[1. Fintech](#1-fintech)** | [`fintech/fintech.ttl`](fintech/fintech.ttl) | [`fintech/shacl.ttl`](fintech/shacl.ttl) | Financial technology domain modeling accounts, parties, and relationships designed to exercise all translation rules. |
| **[2. Pharma](#2-pharma)** | [`pharma/pharma.ttl`](pharma/pharma.ttl) | [`pharma/shacl.ttl`](pharma/shacl.ttl) | Drug discovery ontology modeling chemical compounds, protein targets, and diseases, testing drug indications and binding affinities. |
| **[3. Entertainment](#3-entertainment)** | [`entertainment/entertainment.ttl`](entertainment/entertainment.ttl) | [`entertainment/shacl.ttl`](entertainment/shacl.ttl) | IMDb-like ontology modeling creative works, movies, actors, and directors, designed to test attributes on edge relations. |
| **[4. Knowledgebase](#4-knowledgebase)** | [`knowledgebase/knowledgebase.ttl`](knowledgebase/knowledgebase.ttl) | [`knowledgebase/shacl.ttl`](knowledgebase/shacl.ttl) | Wikipedia-style ontology modeling articles, category hierarchies, and linkages, testing transitive category relations and symmetric links. |
| **[5. Social Fraud](#5-social-fraud)** | [`social_fraud/social_fraud.ttl`](social_fraud/social_fraud.ttl) | [`social_fraud/shacl.ttl`](social_fraud/shacl.ttl) | Social network and fraud detection ontology modeling transactions, device sharing, phone, and IP linking. |
| **[6. Supply Chain](#6-supply-chain)** | [`supply_chain/supply_chain.ttl`](supply_chain/supply_chain.ttl) | [`supply_chain/shacl.ttl`](supply_chain/shacl.ttl) | Manufacturing inventory ontology tracking raw materials, sub-assemblies, and finished products, featuring transitive part hierarchies and symmetric routes. |
| **[7. E-Commerce & Recommendations](#7-e-commerce--recommendations)** | [`ecommerce_recommendations/ecommerce_recommendations.ttl`](ecommerce_recommendations/ecommerce_recommendations.ttl) | [`ecommerce_recommendations/shacl.ttl`](ecommerce_recommendations/shacl.ttl) | E-commerce purchase and behavior ontology modeling customer shopping patterns, symmetric co-purchasing, and transitive hierarchies. |
| **[8. Cybersecurity Threat](#8-cybersecurity-threat)** | [`cybersecurity_threat/cybersecurity_threat.ttl`](cybersecurity_threat/cybersecurity_threat.ttl) | [`cybersecurity_threat/shacl.ttl`](cybersecurity_threat/shacl.ttl) | Network threat intelligence ontology tracking servers, vulnerabilities, threat actors, symmetric network communication, and transitive process trees. |
| **[9. Healthcare Records](#9-healthcare-records)** | [`healthcare_records/healthcare_records.ttl`](healthcare_records/healthcare_records.ttl) | [`healthcare_records/shacl.ttl`](healthcare_records/shacl.ttl) | Clinical EHR ontology modeling patient encounters, practitioners, procedures, symmetric referral networks, and transitive etiology paths. |
| **[10. Smart City IoT](#10-smart-city-iot)** | [`smart_city_iot/smart_city_iot.ttl`](smart_city_iot/smart_city_iot.ttl) | [`smart_city_iot/shacl.ttl`](smart_city_iot/shacl.ttl) | Smart building and IoT sensor network ontology featuring transitive spatial containment, symmetric power grids, and telemetry equivalent classes. |
| **[11. DCSA Shipping](#11-dcsa-shipping)** | [`dcsa_shipping/dcsa_shipping.ttl`](dcsa_shipping/dcsa_shipping.ttl) | [`dcsa_shipping/shacl.ttl`](dcsa_shipping/shacl.ttl) | DCSA standard-aligned logistics ontology modeling bookings, transport calls, containers, transitive voyage legs, and symmetric alliance vessel sharing. |
| **[12. FIBO Financial](#12-fibo-financial)** | [`fibo_financial/fibo_financial.ttl`](fibo_financial/fibo_financial.ttl) | [`fibo_financial/shacl.ttl`](fibo_financial/shacl.ttl) | FIBO standard-aligned financial ontology modeling legal entities, corporations, loans, shares, debt instruments, and transitive parent corporate control chains. |
